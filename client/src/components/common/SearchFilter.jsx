...
export default function SearchFilter({
  ...
  return (
    <form
      className="grid gap-4 rounded-[28px] border border-border bg-surface p-5 shadow-glass md:grid-cols-2 xl:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)_minmax(0,0.9fr)_minmax(0,0.9fr)_minmax(0,0.9fr)_auto]"
      ...
      <FormInput
        ...
        {...register("bhk", {
          ...
          validate: (value) =>
            !value ||
            value.length >= 3 ||
            "BHK must be at least 3 characters",
        })}
      />
      ...
      <FormInput
        ...
        {...register("maxBudget", {
          ...
          validate: (value) => {
            ...
            return (
              Number(value) >= Number(watchedMinBudget) ||
