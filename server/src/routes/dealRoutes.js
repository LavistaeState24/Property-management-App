...
router.get("/summary", protect, authorize("deals", "view"), getRevenueSummaryHandler);
router.get("/staff-reports", protect, authorize("deals", "view"), getStaffClosingReportsHandler);
